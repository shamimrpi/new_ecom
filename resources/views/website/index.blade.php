			...
			<!-- <div class="col-lg-3"></div> -->
				<div class="col-lg-9 offset-lg-3 slider-single-part">
					<div class="owl-carousel owl-theme custom1">
						<div class="slider-part item" style=" background-image:  url('{{ asset('website/images/sofa6.jpg') }}');">
			...
			<div class="row">
				...
				<!-- Single Banner  -->
						...
						<div class="single-banner tab-height  card slider-card">
								...
								<img src="{{ asset('website/images/51.jpg') }}" alt="#">
								<div class="content">
					...
					<!-- Single Banner  -->
						...
						<div class="single-banner card tab-height slider-card">
							<img src="{{ asset('website/images/52.jpg') }}" alt="#">
							<div class="content">
								<p>Flash Sale</p>
					...
					<!-- Single Banner  -->
						...
						<div class="single-banner card tab-height slider-card">
							<img src="{{ asset('website/images/53.jpg') }}" alt="#">
							<div class="content">
								<p>Flash Sale</p>
								<h3>Mid Season <br> Up to <span>40%</span> Off</h3>
								<a href="#" class="">Discover Now</a>
						...
						<div class="single-banner card tab-height slider-card">
							<img src="{{ asset('website/images/54.jpg') }}" alt="#">
							<div class="content">
								<p>Flash Sale</p>
								<h3>Mid Season <br> Up to <span>40%</span> Off</h3>
								<a href="#" class="">Discover Now</a>
						...
						<div class="single-banner card tab-height slider-card">
							<img src="{{ asset('website/images/55.jpg') }}" alt="#">
							<div class="content">
								<p>Flash Sale</p>
								<h3>Mid Season <br> Up to <span>40%</span> Off</h3>
								<a href="#" class="">Discover Now</a>
			...
			<div class="row">
				<div class="col-lg-6 col-12 padding-right">
					<div class="image comming-product">
						<img src="{{ asset('website/images/25.jpeg') }}" alt="#">
					</div>	
				</div>	
